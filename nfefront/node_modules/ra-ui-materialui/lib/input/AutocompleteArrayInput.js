    ...
    return (react_1.default.createElement(downshift_1.default, __assign({ inputValue: filterValue, onChange: handleChange, selectedItem: selectedItems, itemToString: function (item) { return getChoiceValue(item); } }, rest), function (_a) {
        ...
        return (react_1.default.createElement("div", { className: classes.container },
            react_1.default.createElement(core_1.TextField, __assign({ id: id, fullWidth: fullWidth, InputProps: {
                    ...
                    endAdornment: loading && (react_1.default.createElement(AutocompleteInputLoader_1.AutocompleteInputLoader, null)),
                    onBlur: onBlur,
                    ...
                    onFocus: onFocus,
                }, error: !!(touched && (error || submitError)), label: react_1.default.createElement(ra_core_1.FieldTitle, __assign({ label: label }, labelProps, { source: source, resource: resource, isRequired: typeof isRequiredOverride !==
                        'undefined'
                        ? isRequiredOverride
